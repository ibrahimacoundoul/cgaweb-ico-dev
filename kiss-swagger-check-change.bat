...
java -cp target\uber.jar fr.canalplus.cgaweb.swagger.kissSwaggerDiff.KissWSApiDocsMonitoring
REM on ajoute tous les nouveaux fichiers puis commiter et pusher sur la repos github 
REM git pull
REM git add *
REM git commit -am "commit auto des modifications des webservices KISS avec Swagger"
